...
def dequantize_and_gather_k_cache(
    ...
    """
    # The CuTeDSL implementation currently emits SM90-only instructions.
    # Package availability alone is insufficient on Ada (for example L20 / SM89),
    # so use the architecture-portable Triton path there.
